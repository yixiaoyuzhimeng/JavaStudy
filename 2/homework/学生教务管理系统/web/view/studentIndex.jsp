...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1><img src="../images/头像.JPG" class="radius-circle rotate-hover" height="50" alt="" />你好:${student.studentName}</h1>
    </div>
...
<div class="leftnav">
    ...
    <ul style="display:block">
        ...
        <li><a href="/view/courseList" target="right"><span
                class="icon-caret-right"></span>选课管理</a></li>
        <li><a href="/view/stuScoreList" target="right"><span
                class="icon-caret-right"></span>成绩管理</a></li>
    </ul>

    <h2><span class="icon-user"></span>个人管理</h2>
    <%--    <ul style="display:block">--%>
    <%--        <li><a href="<%=path%>singleservlet?method=getsubjectList" target="right"><span--%>
    <%--                class="icon-caret-right"></span>个人中心</a></li>--%>
    <%--    </ul>--%>
